...
<head>
  ...
  <title>Nitin Pratap Singh</title>
  <!-- font icons -->
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
  ...
  <nav class="custom-navbar" data-spy="affix" data-offset-top="20">
    <div class="container">
      <a class="logo" href="#">Nitin Pratap Singh</a>
      <ul class="nav">
        <li class="item">
  ...
  <header id="home" class="header">
    ...
    <div class="header-content container">
      <h1 class="header-title">
        ...
        <span class="down">I am Nitin Pratap Singh</span>
      </h1>
      <p class="header-subtitle">Software Engineer (FullStack)</p>

      <button class="btn btn-primary">
        <a class="text-light" href="#portfolio">Visit My Works</a>
      </button>
    </div>
  </header>
  <!-- end of page header -->
    ...
    <div class="container text-center">
      ...
      <div class="about">
        ...
        <div class="about-caption">
          ...
          <p>
            Hi, I am NITIN PRATAP SINGH. I have 6+ years of experience as an
            IT Professional. I deliver scalable and efficient IT solutions
            that enhance business growth. I am passionate about customer
            problem-solving with my technical skills. I also stay updated with
            the latest industry trends.
            <br />leveraging expertise in Magento 2, Laravel, PHP, MySQL, and
            Nginx to deliver scalable, highperformance robust and scalable
            solutions that meet complex business needs. Good communication and
            organisational skills, Quick learner. Result-orientated and able
            to work independently as well as in teams. Creative, positive
            attitude, ready to learn new concepts. Having a good and Educated
            Background, I value discipline and honesty.
          </p>
          <button class="btn-rounded btn btn-outline-primary mt-4" id="downloadButton">
            Download CV
          </button>
        </div>
      </div>
      ...
      <div class="container text-center">
        ...
        <div class="pricing-wrapper">
          <div class="pricing-card">
            ...
            <a href="#" class="btn btn-primary mt-3 pricing-card-btn"
              >Subscribe</a
            >
          </div>
          <div class="pricing-card">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-sm offset-sm-2 offset-md-3">
          <button class="btn btn-lg my-font btn-light rounded">
            <a href="https://www.linkedin.com/in/nitin-pratap-singh-305133217/">LinkedIn</a>
          </button>
        </div>
      </div>
      <!-- end of row -->
      ...
      <div class="container text-center">
        ...
        <div class="blog-card">
          ...
          <div class="blog-card-body">
            <h5 class="blog-card-title">Consectetur adipisicing elit</h5>
        ...
        <div class="blog-card">
          ...
          <div class="blog-card-body">
            <h5 class="blog-card-title">Explicabo illo</h5>
            ...
            <p>
              ...
              excepturi laborum enim, vitae ipsam atque eum, ad iusto
              consequuntur voluptas, esse doloribus. Perferendis porro quisquam
              vitae exercitationem aliquid, minus eos laborum repudiandae,
              cumque debitis iusto omnis praesentium? Laborum placeat sit
              adipisci illum tempore maxime, esse qui quae? Molestias excepturi
              corporis similique doloribus. Esse vitae earum architecto nulla
              non dolores illum at perspiciatis quod, et deleniti cupiditate
              reiciendis harum facere, delectus eum commodi soluta distinctio
              sit repudiandae possimus sunt. Ipsum, rem.
            </p>
  ...
  <div class="container">
    <footer class="footer">
      <p class="mb-0">
        ...
        &copy; <a href="#">Nitin Pratap Singh</a>
        <!-- Distribution -->
  ...
  <script>
    function downloadPDF(url, filename) {
      ...
      anchor.href = url;
      anchor.download = filename || "download.pdf"; // Default filename if not provided
    ...
    document
      ...
      .addEventListener("click", function () {
        const pdfUrl =
          "https://er-nitinpratapsingh.github.io/Web-App-Developer.pdf";
        const pdfFilename = "NitinPratapSingh_Resume.pdf"; // Optional: specify a custom filename
